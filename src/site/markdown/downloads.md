...
* Maintenance releases:
    [Apache Jackrabbit Oak 1.0.24](#oak1.0),
...
* Latest stable FileVault release: [Apache Jackrabbit FileVault 3.1.24](#vlt)
...
Apache Jackrabbit Oak 1.3.11 (November 27th, 2015)
--------------------------------------------------
Apache Jackrabbit Oak 1.3.11 is an unstable release cut directly from Jackrabbit Oak trunk, with a focus on new features and other improvements. 
For production use we recommend the latest stable 1.2.x release.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.3.11/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.3.11-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.3.11/jackrabbit-oak-1.3.11-src.zip)
    (5.7M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.3.11/jackrabbit-oak-1.3.11-src.zip.asc))
    <br/>SHA1 checksum: `68eabfe7e874791ab1f7e3ac8256c18e71b3d15f`
    <br/>MD5  checksum: `41e287e74bd850593ff1e7cdde3d3b56`
...
Apache Jackrabbit Oak 1.0.24 (November 26th, 2015)
---------------------------------------------------

Jackrabbit Oak 1.0.24 is patch release that contains fixes and improvements over the previous 1.0.x release. 
Jackrabbit Oak 1.0.x releases are considered stable and targeted for production use.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.0.24/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.0.24-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.0.24/jackrabbit-oak-1.0.24-src.zip)
    (5M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.0.24/jackrabbit-oak-1.0.24-src.zip.asc))
    <br/>SHA1 checksum: `072e326daeedc1f9b712c3afaa06b9a0241f085a`
    <br/>MD5  checksum: `41f55fe9bdb43be35999bba29af744b9`

<a class='anchor' name='2.11'></a>
## Apache Jackrabbit 2.11.2 (November 2nd, 2015)

Apache Jackrabbit 2.11.2 is an unstable release cut directly from
Jackrabbit trunk, with a focus on new features and other
improvements. For production use we recommend the latest stable 2.10.x
release.

See the [full release notes](http://www.apache.org/dist/jackrabbit/2.11.2/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.11.2-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/2.11.2/jackrabbit-2.11.2-src.zip)
    (13M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/2.11.2/jackrabbit-2.11.2-src.zip.asc))
    <br/>SHA1 checksum: `f95d38d7c69b799df0f68b49aa0162c16d3a7d9e`
    <br/>MD5  checksum: `a0a7e34e255cbdd16b5d69de9626c9ad`

* [jackrabbit-standalone-2.11.2.jar](http://www.apache.org/dyn/closer.lua/jackrabbit/2.11.2/jackrabbit-standalone-2.11.2.jar) 
    (75M, standalone server, [PGP signature](http://www.apache.org/dist/jackrabbit/2.11.2/jackrabbit-standalone-2.11.2.jar.asc))
    <br/>SHA1 checksum: `d70d80192e5af916bd0e946f6e06e7ef36549da2`
    <br/>MD5  checksum: `b23c8616e1e0f1ebd498765ef4fab3aa`

* [jackrabbit-webapp-2.11.2.war](http://www.apache.org/dyn/closer.lua/jackrabbit/2.11.2/jackrabbit-webapp-2.11.2.war)
    (32M, web application, [PGP signature](http://www.apache.org/dist/jackrabbit/2.11.2/jackrabbit-webapp-2.11.2.war.asc))
    <br/>SHA1 checksum: `4e45ef87ca4967f30643017649a8bc800bb959e6`
    <br/>MD5  checksum: `838a06cf9cedbc4945a602aacdece9e6`

* [jackrabbit-jca-2.11.2.rar](http://www.apache.org/dyn/closer.lua/jackrabbit/2.11.2/jackrabbit-jca-2.11.2.rar) 
    (25M, JCA resource adapter, [PGP signature](http://www.apache.org/dist/jackrabbit/2.11.2/jackrabbit-jca-2.11.2.rar.asc))
    <br/>SHA1 checksum: `6d0895ee39c0de17d915665cea29d02f4d94428b`
    <br/>MD5  checksum: `fc712dc022a07719c1069ec645130f51`
...
Apache Jackrabbit FileVault 3.1.24 (28-September-2015)
-----------------------------------------------------
Jackrabbit FileVault 3.1.24 is the latest stable release of the recently donated repository content synchronization tool.

See the [full release notes](http://www.apache.org/dist/jackrabbit/filevault/3.1.24/RELEASE-NOTES.txt) for more details.

* [jackrabbit-filevault-3.1.24-src.zip](http://www.apache.org/dist/jackrabbit/filevault/3.1.24/jackrabbit-filevault-3.1.24-src.zip) 
    (1.5M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/filevault/3.1.24/jackrabbit-filevault-3.1.24-src.zip.asc))
    <br/>SHA1 checksum: `f91ea83ec139c7ce37a42f82d9d34705688047b1`
    <br/>MD5 checksum: `21a7f42ef6945ae699fca554df38f563`
