...
Apache Jackrabbit 2.17.4 (July 13th, 2018)
------------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/2.17.4/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.17.4-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-2.17.4-src.zip)
    (13M, source zip, [PGP signature](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-2.17.4-src.zip.asc))
    <br/>SHA1   checksum: `6f3de51c435f41e019d0990f12103f2331ad6367`
    <br/>SHA512 checksum: `6796666cd5f427ef3d9928714d9bd9de39d510c073feae89f1fea8ed8c9068eef21e104e0aee2db19f9cdbac7c6f3431b38ffee624081c85d6f1b63b9ba6b465`

* [jackrabbit-standalone-2.17.4.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-standalone-2.17.4.jar)
    (131M, standalone server, [PGP signature](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-standalone-2.17.4.jar.asc))
    <br/>SHA1   checksum: `b1d5292080d96735be9c696ba2a1249912b3b2a7`
    <br/>SHA512 checksum: `0a65b83113490ee4f0a580c37763df5fb4aeb588fbc24e14507fc0b23643186f4aba0c5037f52796ce8ea49bf2eb8adf408e6e541335a451d9ff6824fbf0321d`

* [jackrabbit-webapp-2.17.4.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-webapp-2.17.4.war)
    (64M, web application, [PGP signature](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-webapp-2.17.4.war.asc))
    <br/>SHA1   checksum: `ef045fb1e6412eb9c1a97f87028fa8c1d1db15b4`
    <br/>SHA512 checksum: `8edb129752785187e4e2e7c19053eecdab9f5069791bbd0f57768233f52c811b60d2e907e427e907a0d5c89308b803638fb01a5472c316304acfec008aee5b42`

* [jackrabbit-jca-2.17.4.rar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-jca-2.17.4.rar)
    (64M, JCA resource adapter, [PGP signature](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-jca-2.17.4.rar.asc))
    <br/>SHA1   checksum: `67bd9c89602b76e59120b6acec448b9d8a6e0eaa`
    <br/>SHA512 checksum: `96b66ed72bc82049446ba1cbbec8ea2a465ceb9b878dd12bc427c0ff33817f6d82e40f05dff3c3c3479fa36eab37d5fd3111164e46606e9bffd68ce3fff6f3d5`




<a class='anchor' name='oak1.9'></a>
Apache Jackrabbit Oak 1.9.5 (July 6th, 2018)
--------------------------------------------
Apache Jackrabbit Oak 1.9.5 is an unstable release cut directly from Jackrabbit Oak trunk, with a focus on new features and other improvements.
For production use we recommend the latest stable 1.8.x release.

See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.9.5/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.9.5-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.9.5/jackrabbit-oak-1.9.5-src.zip)
    (14M, source zip, [PGP signature](https://www.apache.org/dist/jackrabbit/oak/1.9.5/jackrabbit-oak-1.9.5-src.zip.asc))
    <br/>SHA1   checksum: `f5b3b278c68c1cf9029871f22e25e45e445129a0`
    <br/>SHA512 checksum: `bcfd09e5eaaa50ff2c44aadfb9a2bc63d0616558c9ebc0d492a0682735db725e4bcc82d3258278cb7203c963ec1a09504ae601df22b4c9a92a0ab64c3b0b0a43`




<a class='anchor' name='oak1.8'></a>
Apache Jackrabbit Oak 1.8.5 (July 6th, 2018)
--------------------------------------------
Apache Jackrabbit Oak 1.8.5 is an incremental feature release based on
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.8.5/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.8.5-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.8.5/jackrabbit-oak-1.8.5-src.zip)
    (14M, source zip, [PGP signature](https://www.apache.org/dist/jackrabbit/oak/1.8.5/jackrabbit-oak-1.8.5-src.zip.asc))
    <br/>SHA1   checksum: `579f85995990be5a69a46cbc62c6eb110f6d020a`
    <br/>SHA512 checksum: `122a3ec9643614675c021fdd6b12b68514a6bf4cc23d1304da3e2ff3d11e5ad7435641145a0ee7f74255bbf4787becd0bf70ee51a30954c9152186568c8931af`




<a class='anchor' name='v2.8'></a>
Apache Jackrabbit 2.8.8 (July 6th, 2018)
----------------------------------------
Apache Jackrabbit 2.8.8 is an incremental feature release based on and compatible with earlier 
stable Jackrabbit 2.x releases. Jackrabbit 2.8.x releases are considered stable and targeted for production use.

See the [full release notes](https://www.apache.org/dist/jackrabbit/2.8.8/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.8.8-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.8.8/jackrabbit-2.8.8-src.zip)
    (13M, source zip, [PGP signature](https://www.apache.org/dist/jackrabbit/2.8.8/jackrabbit-2.8.8-src.zip.asc))
    <br/>SHA1   checksum: `3879970a75b2a7ffa545042b4a6659790a8df21d`
    <br/>SHA512 checksum: `db824e36ea253d3cad36f812d343859ce1c32cd9daf55f4c98f9eb68b58e56648e56d0f96a7b263798f131ebcc6a5c32e6effcbdec0cc9cf736b15e310da340a`

* [jackrabbit-standalone-2.8.8.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.8.8/jackrabbit-standalone-2.8.8.jar)
    (134M, standalone server, [PGP signature](https://www.apache.org/dist/jackrabbit/2.8.8/jackrabbit-standalone-2.8.8.jar.asc))
    <br/>SHA1   checksum: `2687939f5d0a3379969a07f54f54e79e95693558`
    <br/>SHA512 checksum: `5476fdca7c9df582760d17aa5a1ca20a9f48af849cace94858cce09fb45bba47def780b740412001e0b51f4eb7fb61e8a90db05742c995e88533c2b5fb4d200d`

* [jackrabbit-webapp-2.8.8.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.8.8/jackrabbit-webapp-2.8.8.war)
    (75M, web application, [PGP signature](https://www.apache.org/dist/jackrabbit/2.8.8/jackrabbit-webapp-2.8.8.war.asc))
    <br/>SHA1   checksum: `9af439cef38c51836748a6ea26c1fb1e752c788f`
    <br/>SHA512 checksum: `a5309f3d372fbcc69140b68c285e6905c175355a5dc1b5f2f73c2974d0460d085b1791b219d57d3e3fed4784a8da568068d55fd421525deb13598246b5f30c85`

* [jackrabbit-jca-2.8.8.rar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.8.8/jackrabbit-jca-2.8.8.rar)
    (28M, JCA resource adapter, [PGP signature](https://www.apache.org/dist/jackrabbit/2.8.8/jackrabbit-jca-2.8.8.rar.asc))
    <br/>SHA1   checksum: `c29b6e3cf158199d7b3dd4dc3925fa5b94ae667f`
    <br/>SHA512 checksum: `c11cd1e371563889fcdff5cc083b4aed3f8b5b6b9452b19bb128d56340cf4f7ea14db66ca01bdd7ef1f3dd23b43cd7447d2726526b85e9c82f30caf6636d861a`
