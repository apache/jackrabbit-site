...
* Latest stable releases: 
    ...
    * [Apache Jackrabbit Oak 1.16.0](#latest) (Java 8 and later)    
...
Apache Jackrabbit 2.18.3 (August 30th, 2019)
--------------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/2.18.3/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.18.3-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.18.3/jackrabbit-2.18.3-src.zip)
    (13M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-2.18.3-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-2.18.3-src.zip.sha512))

* [jackrabbit-standalone-2.18.3.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.18.3/jackrabbit-standalone-2.18.3.jar)
    (154M, standalone server, [pgp](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-standalone-2.18.3.jar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-standalone-2.18.3.jar.sha512))

* [jackrabbit-webapp-2.18.3.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.18.3/jackrabbit-webapp-2.18.3.war)
    (76M, web application, [pgp](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-webapp-2.18.3.war.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.18.3/jackrabbit-webapp-2.18.3.war.sha512))
...
Apache Jackrabbit Oak 1.8.16 (August 29th, 2019)
------------------------------------------------
Apache Jackrabbit Oak 1.8.16 is an incremental feature release based on
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.8.16/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.8.16-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.8.16/jackrabbit-oak-1.8.16-src.zip)
    (14M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.8.16/jackrabbit-oak-1.8.16-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.8.16/jackrabbit-oak-1.8.16-src.zip.sha512))
...
* [jackrabbit-2.19.4-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.4/jackrabbit-2.19.4-src.zip)
    (13M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-2.19.4-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-2.19.4-src.zip.sha512))

* [jackrabbit-standalone-2.19.4.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.4/jackrabbit-standalone-2.19.4.jar)
    (154M, standalone server, [pgp](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-standalone-2.19.4.jar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-standalone-2.19.4.jar.sha512))

* [jackrabbit-webapp-2.19.4.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.4/jackrabbit-webapp-2.19.4.war)
    (76M, web application, [pgp](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-webapp-2.19.4.war.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.4/jackrabbit-webapp-2.19.4.war.sha512))
...
Apache Jackrabbit Oak 1.16.0 (July 29th, 2019)
----------------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.16.0/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.16.0-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.16.0/jackrabbit-oak-1.16.0-src.zip)
    (15M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.16.0/jackrabbit-oak-1.16.0-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.16.0/jackrabbit-oak-1.16.0-src.zip.sha512))
...
Apache Jackrabbit 2.14.7 (June 12th, 2019)
------------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/2.14.7/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.14.7-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.14.7/jackrabbit-2.14.7-src.zip)
    (13M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-2.14.7-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-2.14.7-src.zip.sha512))

* [jackrabbit-standalone-2.14.7.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.14.7/jackrabbit-standalone-2.14.7.jar)
    (132M, standalone server, [pgp](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-standalone-2.14.7.jar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-standalone-2.14.7.jar.sha512))

* [jackrabbit-webapp-2.14.7.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.14.7/jackrabbit-webapp-2.14.7.war)
    (65M, web application, [pgp](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-webapp-2.14.7.war.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-webapp-2.14.7.war.sha512))

* [jackrabbit-jca-2.14.7.rar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.14.7/jackrabbit-jca-2.14.7.rar)
    (64M, JCA resource adapter, [pgp](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-jca-2.14.7.rar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.14.7/jackrabbit-jca-2.14.7.rar.sha512))




<a class='anchor' name='v2.16'></a>
Apache Jackrabbit 2.16.4 (May 6th, 2019)
----------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/2.16.4/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.16.4-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.16.4/jackrabbit-2.16.4-src.zip)
    (13M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-2.16.4-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-2.16.4-src.zip.sha512))

* [jackrabbit-standalone-2.16.4.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.16.4/jackrabbit-standalone-2.16.4.jar)
    (144M, standalone server, [pgp](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-standalone-2.16.4.jar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-standalone-2.16.4.jar.sha512))

* [jackrabbit-webapp-2.16.4.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.16.4/jackrabbit-webapp-2.16.4.war)
    (71M, web application, [pgp](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-webapp-2.16.4.war.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.16.4/jackrabbit-webapp-2.16.4.war.sha512))
...
Apache Jackrabbit Oak 1.4.24 (January 11th, 2019)
-------------------------------------------------
Apache Jackrabbit Oak 1.4.24 is an incremental feature release based on
and compatible with earlier stable Jackrabbit Oak 1.x
releases. Jackrabbit Oak 1.4.x releases are considered stable and
targeted for production use.

See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.4.24/RELEASE-NOTES.txt) for more details.
...
See the [full release notes](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.4/RELEASE-NOTES.md) for more details.

* [filevault-package-maven-plugin-1.0.4-source-release.zip](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.4/filevault-package-maven-plugin-1.0.4-source-release.zip)
    (1.5M, source zip, [PGP signature](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.4/filevault-package-maven-plugin-1.0.4-source-release.zip.asc))
    * [SHA512 checksum](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.4/filevault-package-maven-plugin-1.0.4-source-release.zip.sha512)
