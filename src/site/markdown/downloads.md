...
Apache Jackrabbit Oak 1.3.2 (Jun 25th, 2015)
----------------------------------------------
Apache Jackrabbit Oak 1.3.2 is an unstable release cut directly from Jackrabbit Oak trunk, with a focus on new features and other improvements. 
For production use we recommend the latest stable 1.2.x release.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.3.2/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.3.2-src.zip](http://www.apache.org/dyn/closer.cgi/jackrabbit/oak/1.3.2/jackrabbit-oak-1.3.2-src.zip)
    (5.7M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.3.2/jackrabbit-oak-1.3.2-src.zip.asc))
    <br/>SHA1 checksum: `ccb6fcddd937679fc9d7fa2e5f079783530041e8`
    <br/>MD5  checksum: `49edcc97bb0a80c3c17468c151396409`
