...
* Latest stable releases: 
    ...
    * [Apache Jackrabbit Oak 1.22.0](#latest) (Java 8 and later)    
...
* Latest stable FileVault releases: 
    * [Apache Jackrabbit FileVault 3.4.2](#vlt) (Java 8 and later)
    * [Apache Jackrabbit FileVault 3.2.8](#vltjava7) (Java 7 and later)
* Latest stable FileVault Plugin release: [Apache Jackrabbit FileVault Package Maven Plugin 1.1.0](#vltplg)
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.4.25/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.4.25-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.4.25/jackrabbit-oak-1.4.25-src.zip)
    (10M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.4.25/jackrabbit-oak-1.4.25-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.4.25/jackrabbit-oak-1.4.25-src.zip.sha512))




<a class='anchor' name='latest'></a>
Apache Jackrabbit Oak 1.22.0 (January 16th, 2020)
-------------------------------------------------
...
See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.22.0/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.22.0-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.22.0/jackrabbit-oak-1.22.0-src.zip)
    (15M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.22.0/jackrabbit-oak-1.22.0-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.22.0/jackrabbit-oak-1.22.0-src.zip.sha512))




<a class='anchor' name='oak1.6'></a>
Apache Jackrabbit Oak 1.6.19 (January 13th, 2020)
-----------------------------------------------
Apache Jackrabbit Oak 1.6.19 is an incremental feature release based on
and compatible with earlier stable Jackrabbit Oak 1.6.x
releases. Jackrabbit Oak 1.6.x releases are considered stable and
targeted for production use.

See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.6.19/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.6.19-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.6.19/jackrabbit-oak-1.6.19-src.zip)
    (11M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.6.19/jackrabbit-oak-1.6.19-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.6.19/jackrabbit-oak-1.6.19-src.zip.sha512))
...
Apache Jackrabbit Oak 1.10.7 (December 12th, 2019)
--------------------------------------------------
Apache Jackrabbit Oak 1.10.7 is an incremental feature release based on
and compatible with earlier stable Jackrabbit Oak 1.x
...
Apache Jackrabbit 2.19.6 (December 10th, 2019)
----------------------------------------------
See the [full release notes](https://www.apache.org/dist/jackrabbit/2.19.6/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.19.6-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.6/jackrabbit-2.19.6-src.zip)
    (13M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-2.19.6-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-2.19.6-src.zip.sha512))

* [jackrabbit-standalone-2.19.6.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.6/jackrabbit-standalone-2.19.6.jar)
    (154M, standalone server, [pgp](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-standalone-2.19.6.jar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-standalone-2.19.6.jar.sha512))

* [jackrabbit-webapp-2.19.6.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.6/jackrabbit-webapp-2.19.6.war)
    (76M, web application, [pgp](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-webapp-2.19.6.war.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-webapp-2.19.6.war.sha512))

* [jackrabbit-jca-2.19.6.rar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.19.6/jackrabbit-jca-2.19.6.rar)
    (75M, JCA resource adapter, [pgp](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-jca-2.19.6.rar.asc), [sha512](https://www.apache.org/dist/jackrabbit/2.19.6/jackrabbit-jca-2.19.6.rar.sha512))




<a class='anchor' name='oak1.8'></a>
Apache Jackrabbit Oak 1.8.18 (November 29th, 2019)
------------------------------------------------
Apache Jackrabbit Oak 1.8.18 is an incremental feature release based on
and compatible with earlier stable Jackrabbit Oak 1.x
releases. Jackrabbit Oak 1.8.x releases are considered stable and
targeted for production use.

See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.8.18/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.8.18-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.8.18/jackrabbit-oak-1.8.18-src.zip)
    (14M, source zip, [pgp](https://www.apache.org/dist/jackrabbit/oak/1.8.18/jackrabbit-oak-1.8.18-src.zip.asc), [sha512](https://www.apache.org/dist/jackrabbit/oak/1.8.18/jackrabbit-oak-1.8.18-src.zip.sha512))
...
Apache Jackrabbit FileVault 3.4.2 (Jan 15th, 2020)
--------------------------------------------------
...
Apache Jackrabbit FileVault Package Maven Plugin 1.1.0 (Jan 15th, 2020)
------------------------------------------------------------------------
