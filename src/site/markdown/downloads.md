...
Apache Jackrabbit Oak 1.9.6 (July 23rd, 2018)
--------------------------------------------
Apache Jackrabbit Oak 1.9.6 is an unstable release cut directly from Jackrabbit Oak trunk, with a focus on new features and other improvements.
For production use we recommend the latest stable 1.8.x release.

See the [full release notes](https://www.apache.org/dist/jackrabbit/oak/1.9.6/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.9.6-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.9.6/jackrabbit-oak-1.9.6-src.zip)
    (14M, source zip, [PGP signature](https://www.apache.org/dist/jackrabbit/oak/1.9.6/jackrabbit-oak-1.9.6-src.zip.asc))
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/oak/1.9.6/jackrabbit-oak-1.9.6-src.zip.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/oak/1.9.6/jackrabbit-oak-1.9.6-src.zip.sha512)
...
* [jackrabbit-2.17.4-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-2.17.4-src.zip)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-2.17.4-src.zip.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-2.17.4-src.zip.sha512)
...
* [jackrabbit-standalone-2.17.4.jar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-standalone-2.17.4.jar)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-standalone-2.17.4.jar.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-standalone-2.17.4.jar.sha512)
...
* [jackrabbit-webapp-2.17.4.war](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-webapp-2.17.4.war)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-webapp-2.17.4.war.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-webapp-2.17.4.war.sha512)
...
* [jackrabbit-jca-2.17.4.rar](https://www.apache.org/dyn/closer.lua/jackrabbit/2.17.4/jackrabbit-jca-2.17.4.rar)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-jca-2.17.4.rar.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/2.17.4/jackrabbit-jca-2.17.4.rar.sha512)
...
* [jackrabbit-oak-1.8.5-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.8.5/jackrabbit-oak-1.8.5-src.zip)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/oak/1.8.5/jackrabbit-oak-1.8.5-src.zip.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/oak/1.8.5/jackrabbit-oak-1.8.5-src.zip.sha512)
...
* [jackrabbit-oak-1.6.12-src.zip](https://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.6.12/jackrabbit-oak-1.6.12-src.zip)
    ...
    * [SHA1 checksum](https://www.apache.org/dist/jackrabbit/oak/1.6.12/jackrabbit-oak-1.6.12-src.zip.sha1)
    * [SHA512 checksum](https://www.apache.org/dist/jackrabbit/oak/1.6.12/jackrabbit-oak-1.6.12-src.zip.sha512)
...
* [filevault-package-maven-plugin-1.0.1-source-release.zip](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.1/filevault-package-maven-plugin-1.0.1-source-release.zip)
    ...
    * [SHA1 checksum](https://dist.apache.org/repos/dist/release/jackrabbit/filevault-package-maven-plugin/1.0.1/filevault-package-maven-plugin-1.0.1-source-release.zip.sha1)
