...
* Latest stable release: 
    ...
    * [Apache Jackrabbit Oak 1.2.x](#oak)
...
Apache Jackrabbit Oak 1.3.15 (February 8th, 2016)
--------------------------------------------------
Apache Jackrabbit Oak 1.3.15 is an unstable release cut directly from Jackrabbit Oak trunk, with a focus on new features and other improvements. 
For production use we recommend the latest stable 1.2.x release.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.3.15/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.3.15-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.3.15/jackrabbit-oak-1.3.15-src.zip)
    (5.7M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.3.15/jackrabbit-oak-1.3.15-src.zip.asc))
    <br/>SHA1 checksum: `aba9e0aea9400edb47eb498f63bede1969a31132`
    <br/>MD5  checksum: `c6c7fe79cc77bf095e0e62d481a6d057`

<a class='anchor' name='oak'></a>
Apache Jackrabbit Oak 1.2.11 (February 15th, 2015)
--------------------------------------------------
Jackrabbit Oak 1.2.11 is patch release that contains fixes and
improvements over the previous 1.2.x release.  
Jackrabbit Oak 1.2.x releases are considered stable and targeted for
production use.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.2.11/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.2.11-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.2.11/jackrabbit-oak-1.2.11-src.zip)
    (5.7M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.2.11/jackrabbit-oak-1.2.11-src.zip.asc))
    <br/>SHA1 checksum: `635edf5b3c62be4d2a06756d967d476580bdad44`
    <br/>MD5  checksum: `0578fb8ead80e6310a1a0b716f8f0e3f`

<a class='anchor' name='oak1.0'></a>
Apache Jackrabbit Oak 1.0.27 (February 12th, 2016)
---------------------------------------------------

Jackrabbit Oak 1.0.27 is patch release that contains fixes and improvements over the previous 1.0.x release. 
Jackrabbit Oak 1.0.x releases are considered stable and targeted for production use.

See the [full release notes](http://www.apache.org/dist/jackrabbit/oak/1.0.27/RELEASE-NOTES.txt) for more details.

* [jackrabbit-oak-1.0.27-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/oak/1.0.27/jackrabbit-oak-1.0.27-src.zip)
    (5M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/oak/1.0.27/jackrabbit-oak-1.0.27-src.zip.asc))
...
## Apache Jackrabbit 2.12.0 (February 12th, 2016)
...
See the [full release notes](http://www.apache.org/dist/jackrabbit/2.12.0/RELEASE-NOTES.txt) for more details.

* [jackrabbit-2.12.0-src.zip](http://www.apache.org/dyn/closer.lua/jackrabbit/2.12.0/jackrabbit-2.12.0-src.zip)
    (13M, source zip, [PGP signature](http://www.apache.org/dist/jackrabbit/2.12.0/jackrabbit-2.12.0-src.zip.asc))  
    SHA1 checksum: `9667a07530a46252b21183d4b3f9db5de5258ff5`  
    MD5  checksum: `9d996802f4c6056498aed9d211ccf5ad`

* [jackrabbit-jca-2.12.0.rar](http://www.apache.org/dyn/closer.lua/jackrabbit/2.12.0/jackrabbit-jca-2.12.0.rar)
    (25M, JCA resource adapter, [PGP signature](http://www.apache.org/dist/jackrabbit/2.12.0/jackrabbit-jca-2.12.0.rar.asc))  
    SHA1 checksum: `8cd11934db2bfe1ebc07eb74d0dda62b31249909`  
    MD5  checksum: `10893ab55c01d040cd6ce66176245039`

* [jackrabbit-standalone-2.12.0.jar](http://www.apache.org/dyn/closer.lua/jackrabbit/2.12.0/jackrabbit-standalone-2.12.0.jar)
    (75M, standalone server, [PGP signature](http://www.apache.org/dist/jackrabbit/2.12.0/jackrabbit-standalone-2.12.0.jar.asc))  
    SHA1 checksum: `e1391fa865fc8e3ce0aeddcc9f339a78773f1eef`  
    MD5  checksum: `02371a26e4af88dd4e1e2430a643fd13`

* [jackrabbit-webapp-2.12.0.war](http://www.apache.org/dyn/closer.lua/jackrabbit/2.12.0/jackrabbit-webapp-2.12.0.war)
    (32M, web application, [PGP signature](http://www.apache.org/dist/jackrabbit/2.12.0/jackrabbit-webapp-2.12.0.war.asc))  
    SHA1 checksum: `b6df04bc836e67929fc9f2a790d25c4ba07734ab`  
    MD5  checksum: `5d2cdd55e49c88cd9343611971c9e177`
